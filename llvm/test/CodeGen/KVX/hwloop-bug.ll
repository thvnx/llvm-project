...
; RUN: llc -O2 -disable-kvx-hwloops=false -o - %s | FileCheck %s
...
; CHECK-NEXT:    make $r4 = 0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r5 ? .LBB0_19
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r5, .LBB0_2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_19: # %for.body
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    make $r8 = 0xdeaddead
; CHECK-NEXT:    addd $r7 = $r7, -2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 0[$r6] = $r8
; CHECK-NEXT:    addd $r6 = $r6, 4
; CHECK-NEXT:    cb.dnez $r7 ? .LBB0_7
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.8: # %middle.block
; CHECK-NEXT:    compd.eq $r4 = $r4, $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r4 ? .LBB0_9
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_5: # %for.body4
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    make $r4 = 0xdead
; CHECK-NEXT:    addd $r6 = $r0, 1
; CHECK-NEXT:    compd.ltu $r5 = $r0, 255
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sh.xs $r0[$r1] = $r4
; CHECK-NEXT:    copyd $r0 = $r6
; CHECK-NEXT:    cb.odd $r5 ? .LBB0_5
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_9: # %for.cond10.preheader
; CHECK-NEXT:    make $r0 = 0
; CHECK-NEXT:    cb.wlez $r2 ? .LBB0_12
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.10: # %for.body13.preheader
; CHECK-NEXT:    zxwd $r0 = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    make $r0 = 0
; CHECK-NEXT:    copyd $r1 = $r3
; CHECK-NEXT:    cb.dlez $r2 ? .LBB0_20
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r2, .LBB0_11
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_20: # %for.body13
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_11: # Block address taken
; CHECK-NEXT:    # %for.cond20.preheader
; CHECK-NEXT:    compw.gtu $r1 = $r2, 15
; CHECK-NEXT:    copyd $r0 = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r1 ? .LBB0_18
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_12: # %for.body23.preheader
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_14: # %vector.ph74
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_15: # %vector.body71
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    make $r6 = 0xbeefbeef
; CHECK-NEXT:    addd $r5 = $r5, -2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 0[$r4] = $r6
; CHECK-NEXT:    addd $r4 = $r4, 4
; CHECK-NEXT:    cb.dnez $r5 ? .LBB0_15
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.16: # %middle.block69
; CHECK-NEXT:    compd.eq $r1 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r1 ? .LBB0_18
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_17: # %for.body23
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    make $r1 = 0xbeef
; CHECK-NEXT:    addd $r4 = $r0, 1
; CHECK-NEXT:    compd.ltu $r2 = $r0, 15
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sh.xs $r0[$r3] = $r1
; CHECK-NEXT:    copyd $r0 = $r4
; CHECK-NEXT:    cb.odd $r2 ? .LBB0_17
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_18: # %for.end28
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
entry:

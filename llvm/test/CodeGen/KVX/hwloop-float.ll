...
; RUN: llc --disable-kvx-hwloops=false -O3 < %s | FileCheck %s
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fcompw.olt $r4 = $r1, 0x42c80000
; CHECK-NEXT:    sw.xs $r3[$r0] = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.wnez $r4 ? .LBB0_1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.2:
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
...
; CHECK-LABEL: f64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    make $r2 = 0x3fe0000000000000
; CHECK-NEXT:    make $r1 = 0x4059000000000000
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd.xs $r3[$r0] = $r2
; CHECK-NEXT:    faddd $r2 = $r2, 0x3ff0000000000000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fixedd.rz $r3 = $r2, 0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxwd $r3 = $r3
...
; CHECK-NEXT:    faddd $r2 = $r3, 0x3ff0000000000000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fcompd.olt $r5 = $r2, $r1
; CHECK-NEXT:    sd.xs $r4[$r0] = $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.wnez $r5 ? .LBB1_1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.2:
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;

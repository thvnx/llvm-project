...
; CHECK-NEXT:    make $r2 = 1000
; CHECK-NEXT:    make $r1 = 1000
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_1: # %for.body
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    sw.xs $r2[$r0] = $r1
; CHECK-NEXT:    compd.gtu $r3 = $r2, 503
; CHECK-NEXT:    addd $r2 = $r2, -4
; CHECK-NEXT:    addw $r1 = $r1, -4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r3 ? .LBB0_1
; CHECK-NEXT:    ;;
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %cmp = icmp ugt i64 %indvars.iv, 503
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    sw.xs $r2[$r0] = $r1
; CHECK-NEXT:    compd.gtu $r3 = $r2, 504
; CHECK-NEXT:    addd $r2 = $r2, -4
; CHECK-NEXT:    addw $r1 = $r1, -4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r3 ? .LBB1_1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.2: # %for.cond.cleanup
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
...
for.body:                                         ; preds = %entry, %for.body
  ...
  store i32 %1, i32* %arrayidx, align 4
  %indvars.iv.next = add nsw i64 %indvars.iv, -4
  %cmp = icmp ugt i64 %indvars.iv, 504
  br i1 %cmp, label %for.body, label %for.cond.cleanup
}

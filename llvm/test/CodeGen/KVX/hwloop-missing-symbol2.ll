...
; CHECK-NEXT:    make $r3 = b
; CHECK-NEXT:    make $r2 = 4
; CHECK-NEXT:    compw.eq $r5 = $r1, 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r4 = 0[$r3]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r2
; CHECK-NEXT:    cb.even $r5 ? .LBB0_16
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.15: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r2 = $r0, 3
; CHECK-NEXT:    goto .LBB0_6
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_16: # %for.body.prol.3
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    ld $r3 = 0[$r3]
; CHECK-NEXT:    compw.eq $r4 = $r1, 4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r2
; CHECK-NEXT:    cb.even $r4 ? .LBB0_18
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.17: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r2 = $r0, 4
; CHECK-NEXT:    goto .LBB0_6
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r1] = $r2
; CHECK-NEXT:    addw $r2 = $r0, 7
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_6: # %for.body.prol.loopexit
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    compw.gtu $r0 = $r0, -8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r0 ? .LBB0_7
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.10: # %for.body.preheader1
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    maxw $r0 = $r2, -8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfw $r0 = $r2, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addw $r0 = $r0, 7
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_24
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.42: # %while.cond.loopexit.1
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_43
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    negw $r1 = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andw $r2 = $r1, 7
; CHECK-NEXT:    copyd $r1 = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.weqz $r2 ? .LBB0_39
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.25: # %for.body.prol.110
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    make $r3 = b
; CHECK-NEXT:    make $r1 = 4
; CHECK-NEXT:    compw.eq $r5 = $r2, 1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r4 = 0[$r3]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_27
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.26: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 1
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_27: # %for.body.prol.1.1
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    ld $r3 = 0[$r3]
; CHECK-NEXT:    compw.eq $r4 = $r2, 2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_29
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.28: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 2
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    make $r3 = b
; CHECK-NEXT:    make $r1 = 4
; CHECK-NEXT:    compw.eq $r5 = $r2, 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r4 = 0[$r3]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_31
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.30: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 3
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_31: # %for.body.prol.3.1
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    ld $r3 = 0[$r3]
; CHECK-NEXT:    compw.eq $r4 = $r2, 4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_33
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.32: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 4
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    make $r3 = b
; CHECK-NEXT:    make $r1 = 4
; CHECK-NEXT:    compw.eq $r5 = $r2, 5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r4 = 0[$r3]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_35
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.34: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 5
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_35: # %for.body.prol.5.1
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    ld $r3 = 0[$r3]
; CHECK-NEXT:    compw.eq $r2 = $r2, 6
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r2 ? .LBB0_37
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.36: # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    addw $r1 = $r0, 6
; CHECK-NEXT:    goto .LBB0_38
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r2] = $r4
; CHECK-NEXT:    compw.lt $r2 = $r1, -8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r0 = 0[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r0] = $r4
; CHECK-NEXT:    copyd $r1 = $r3
; CHECK-NEXT:    cb.odd $r2 ? .LBB0_40
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_44
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.62: # %while.cond.loopexit.2
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_63
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_64
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.82: # %while.cond.loopexit.3
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_83
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_84
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.102: # %while.cond.loopexit.4
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_103
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_104
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.122: # %while.cond.loopexit.5
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_123
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    copyd $r1 = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.weqz $r2 ? .LBB0_119
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_107
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_109
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_111
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_113
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_115
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r2 ? .LBB0_117
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wltz $r0 ? .LBB0_124
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.142: # %while.cond.loopexit.6
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wnez $r1 ? .LBB0_143
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    copyd $r1 = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.weqz $r2 ? .LBB0_139
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_127
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_129
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_131
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_133
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_135
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r2 ? .LBB0_137
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    # in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    cb.wgez $r0 ? .LBB0_162
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    copyd $r1 = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.weqz $r2 ? .LBB0_159
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_147
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_149
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_151
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r4 ? .LBB0_153
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r4] = $r1
; CHECK-NEXT:    cb.even $r5 ? .LBB0_155
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sb 0[$r3] = $r1
; CHECK-NEXT:    cb.even $r2 ? .LBB0_157
; CHECK-NEXT:    ;;

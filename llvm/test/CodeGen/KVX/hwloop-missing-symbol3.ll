...
; CHECK-NEXT:    make $r7 = 0
; CHECK-NEXT:    addd $r5 = $r1, 3
; CHECK-NEXT:    compd.eq $r8 = $r4, 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r6[$r3] = $r7

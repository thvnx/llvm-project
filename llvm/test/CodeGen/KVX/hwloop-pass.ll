...
; CHECK-NEXT:    addd $r0 = $r0, 396
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfd $r2 = $r1, 100
; CHECK-NEXT:    make $r1 = 99
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r2 ? .LBB3_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r2, .LBB3_2
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:  # %bb.1: # %for.body.preheader
; CHECK-NEXT:    zxwd $r2 = $r1
; CHECK-NEXT:    make $r4 = 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addd $r3 = $r2, 1
; CHECK-NEXT:    addx4d $r0 = $r2, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfd $r3 = $r4, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r3 ? .LBB6_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r3, .LBB6_2
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    addd $r0 = $r0, -4
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB6_2: # Block address taken
; CHECK-NEXT:    # %for.cond.cleanup
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
entry:
...
; CHECK-NEXT:    addx4d $r0 = $r2, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfd $r3 = $r3, 99
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r3 ? .LBB7_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r3, .LBB7_2
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    addd $r0 = $r0, 4
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB7_2: # Block address taken
; CHECK-NEXT:    # %for.cond.cleanup
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
entry:
...
; CHECK-NEXT:    addx4d $r0 = $r2, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r3 ? .LBB9_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r3, .LBB9_2
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    addd $r0 = $r0, -4
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB9_2: # Block address taken
; CHECK-NEXT:    # %for.cond.cleanup
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
entry:
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r2 ? .LBB11_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r2, .LBB11_2
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    addd $r0 = $r0, -4
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB11_2: # Block address taken
; CHECK-NEXT:    # %for.cond.cleanup
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
entry:

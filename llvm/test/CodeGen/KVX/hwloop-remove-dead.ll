...
; CHECK-NEXT:    cb.dlez $r0 ? .LBB0_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r0, .LBB0_4
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_3: # %for.body3
; CHECK-NEXT:    # Parent Loop BB0_2 Depth=1
; CHECK-NEXT:    # => This Inner Loop Header: Depth=2
; CHECK-NEXT:    zxwd $r6 = $r5
; CHECK-NEXT:    addw $r5 = $r5, 1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    lhz.xs $r7 = $r6[$r1]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addw $r7 = $r7, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sh.xs $r6[$r1] = $r7
; CHECK-NEXT:    ;;

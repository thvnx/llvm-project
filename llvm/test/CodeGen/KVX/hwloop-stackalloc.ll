...
; CHECK-NEXT:    cb.dlez $r1 ? .LBB0_3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r1, .LBB0_2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_3: # %for.body
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    mulw $r1 = $r2, $r2
...
; CHECK-NEXT:    cb.dlez $r0 ? .LBB1_2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r0, .LBB1_3
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.dlez $r5 ? .LBB1_4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r5, .LBB1_5
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    slld $r4 = $r1, 2
; CHECK-NEXT:    make $r1 = 0
; CHECK-NEXT:    cb.dlez $r0 ? .LBB1_8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    loopdo $r0, .LBB1_7
; CHECK-NEXT:    ;;

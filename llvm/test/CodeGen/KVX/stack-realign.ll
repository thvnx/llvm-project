...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r1 = 184[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r3 = 136[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r4 = 160[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r5 = 168[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r6 = 176[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r7 = 152[$r14]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r8 = 144[$r14]

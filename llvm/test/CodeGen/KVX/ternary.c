...
long Int64TernaryRegImm2(long v1, bool value) {
  // CHECK: Int64TernaryRegImm2:
  // CHECK: cmoved.weqz $r1 ? $r0 = 4
  // CHECK: ret
  // CHECK: ;;
  return value ? v1 : 4;
}
...
long Int64TernaryImmReg2(long v2, bool value) {
  // CHECK: Int64TernaryImmReg2:
  // CHECK: cmoved.wnez $r1 ? $r0 = 3
  // CHECK: ret
  // CHECK: ;;
  return value ? 3 : v2;
}
...
_Float16 Float16TernaryCond(int v) {
  return v == 0 ? 7.0f16 : 5.0f16;
  // CHECK: Float16TernaryCond:
  // CHECK: copyw $r1 = $r0
  // CHECK: make $r0 = 0x4700
  // CHECK: ;;
  // CHECK: cmoved.wnez $r1 ? $r0 = 0x4500
  // CHECK: ret
}
